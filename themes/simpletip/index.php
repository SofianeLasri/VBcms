...
<body>
	...
	<div class="bottomContent" style="background-color: <?=getParameters("stMainColor")?>; border-color: <?=getParameters("stSecondaryColor")?>;">
	...
	<div class="leftInfos">
		<div class="serverInfo" style="background-color: <?=getParameters("stThirdColor")?>;">
